  ...
  return (
    ...
    <div className='Home'>
      <p>
        ...
        <br />
        <br /> 
        Whether on small scale or large scale, traditional, contemporary, or unique in style we approach each unique project incorporating custom colour, space, shape, size, form, and texture to suit each client. With every new outdoor space we create, we consider the future of your landscape investment, looking 5, 10, 20, 30 years in the future. We want to maximise your property’s potential and work together to create your perfect outdoor experience. For us, it’s the quality of work we provide, not the quantity of projects we can put under our belt.
        <br />
        <br />
